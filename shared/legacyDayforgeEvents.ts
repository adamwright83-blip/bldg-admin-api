...
export type LegacyDayforgeProductEventName =
 ...
 */
export interface LegacyDayforgeProductEventPropertyMap {
  territory_address_submitted: {
...
export type LegacyDayforgeProductEventProperties<
  Name extends LegacyDayforgeProductEventName,
> = Partial<LegacyDayforgeProductEventPropertyMap[Name]>;
...
export const DAYFORGE_PRODUCT_EVENT_PROPERTY_KEYS = {
  ...
  [Name in LegacyDayforgeProductEventName]: readonly (keyof LegacyDayforgeProductEventPropertyMap[Name])[];
};
...
>(
...
): LegacyDayforgeProductEventProperties<Name> {
  ...
  return sanitized as LegacyDayforgeProductEventProperties<Name>;
}
...
/**
 * The subset of LegacyDayforgeProductEventName a Goldline gameplay client may
...
export const GOLDLINE_CLIENT_EVENT_NAMES = [
  ...
  "future_pressure_presented",
  "growth_action_opened",
] as const satisfies readonly LegacyDayforgeProductEventName[];
