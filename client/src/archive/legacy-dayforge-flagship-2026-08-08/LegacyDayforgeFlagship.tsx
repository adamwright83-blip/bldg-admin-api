...
export default function LegacyDayforgeFlagship() {
  ...
  return (
    <div ref={pageRef} className={`ff-page${posterMode ? " is-poster" : ""}`} id="top">
      ...
      <footer className="ff-footer"><LegacyDayforgeMark /><p>Built in Los Angeles for owners who still do the work.</p><a href={`mailto:${FALLBACK_EMAIL}`}>{FALLBACK_EMAIL}</a></footer>
