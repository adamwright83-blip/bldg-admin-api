  ...
  return <main className="pwc-page">
    ...
    <section className="pwc-world-layout">
      <div className="pwc-world" aria-label="Live world overview of Los Angeles customer geography">
        ...
        <button type="button" className="pwc-building cpe" onClick={() => onNavigate("/growth/tower-wars")}><span /><strong>Century Park East</strong><small>Century City · {customers.isLoading || customers.isError ? "—" : buildingCounts.century} customers</small></button>
        <button type="button" className="pwc-building opus" onClick={() => onNavigate("/growth/tower-wars")}><span /><strong>OPUS LA</strong><small>Koreatown · {customers.isLoading || customers.isError ? "—" : buildingCounts.opus} customers</small></button>
