  ...
  return <main className="pwc-page">
    ...
    <section className="pwc-world-layout">
      <div className="pwc-world" aria-label="Live world overview of Los Angeles customer geography">
        ...
        <button type="button" className="pwc-building opus" onClick={() => onNavigate("/growth/tower-wars")}><img className="pwc-building-art" src="/assets/admin/control-room/tower-wars/opus-la-siege-driver-v4.png" alt="" /><strong>OPUS LA</strong><small>Koreatown · {customers.isLoading || customers.isError ? "—" : buildingCounts.opus} customers</small></button>
