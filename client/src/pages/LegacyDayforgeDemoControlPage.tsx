...
function ProviderRail({
  ...
  status?: LegacyDayforgeDemoStatus["providerStatus"];
}) {
  return (
...
export default function LegacyDayforgeDemoControlPage() {
  useEffect(() => {
        ...
        legacyLegacyDayforgeDemo: {
          getStatus: {
            useQuery: (
              ...
              data: LegacyDayforgeDemoStatus | undefined;
              isLoading: boolean;
