...
export const ASSET_GROUPS: readonly AssetGroup[] = [
  ...
  {
    id: "companions",
    dir: "/assets/goldline/companions/rook",
    surface: "expedition",
    status: "live",
    style: "goldline_current",
    pivot: "center_bottom",
    pipeline: "blender_rendered",
    dynamic: true,
    loadedBy: ["client/src/components/driver/CompanionUnlockReveal.tsx"],
    note:
      "Rook's baked idle frames. Mesh generated by TRELLIS.2 from Adam's concept art, stood " +
      "upright, painted by projecting the concept from its registered view (yaw 38, elevation " +
      "+14), and rendered through scripts/assets/blender/rig.py. Paths are read at runtime from " +
      "rook.frames.json by the unlock reveal.",
  },
  {
    ...
    loadedBy: ["client/src/components/driver/CompanionUnlockReveal.tsx"],
    note:
      "Adam's own concept art for Rook, shown in a one-time full-screen reveal on the live driver game home as a " +
