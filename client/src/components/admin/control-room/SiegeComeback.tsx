...
export function SiegeComeback({ buildingId, onClose, onContinue }: {
  ...
  return <section className={`tw-comeback is-${architecture.feature}`} aria-label="Engineer the comeback">
    ...
    <div className="tw-comeback-facade" aria-hidden><i className="tw-depth-callbox"/><i className="tw-depth-doors"/><i className="tw-depth-elevator"/><i className="tw-depth-lights"/></div>
    <div className="tw-comeback-copy">
      ...
      <button type="button" onClick={onContinue}>Continue inside the business work <ArrowRight /></button>
    </div>
  </section>;
}
