...
test.describe("Boss demo journey — desktop", () => {
  ...
  test("landing through territory preview, mission trigger, and admin surfaces render", async ({
    ...
    // e2e/legacy-dayforge/territoryPreview.spec.ts; duplicating a real submission here
    ...
    await expect(page.getByTestId("legacy-dayforge-territory-preview")).toBeVisible();
