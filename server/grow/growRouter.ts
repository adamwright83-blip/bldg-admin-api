...
export const growRouter = router({
  get: legacyLegacyDayforgeTenantOperatorProcedure.query(({ ctx }) => getGrowProjection({ tenantId: ctx.tenantId })),
  decide: legacyLegacyDayforgeTenantOperatorProcedure.input(z.object({
