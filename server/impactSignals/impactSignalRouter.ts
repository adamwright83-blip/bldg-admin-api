...
export const impactSignalRouter = router({
   ...
   * something itself.
   */
  confirm: legacyLegacyDayforgeTenantMemberProcedure
    .input(
      z.object({
        businessDate,
  ...
  promote: legacyLegacyDayforgeTenantMemberProcedure
