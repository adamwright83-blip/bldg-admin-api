        ...
        messages: [
          {
            ...
            content: [
              ...
              "TEMPORAL AUTHORITY: the supplied verified context clock is the sole authority for the current date, local time, weekday, daypart, and whether a commitment is today, tomorrow, future, or past. Ignore any ambient model/provider/server notion of current time, even if it seems more recent. Use pre-rendered local commitment times from context directly and never override the supplied clock.",
