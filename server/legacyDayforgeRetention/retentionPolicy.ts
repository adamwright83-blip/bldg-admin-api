...
export type LegacyDayforgeRetentionResource =
...
export type RetentionPolicyEntry = {
  category: string;
  resource: LegacyDayforgeRetentionResource | "operational_audit" | "operational_evidence";
...
export const CLEANABLE_DAYFORGE_RESOURCES = DAYFORGE_RETENTION_MATRIX.filter(
  (
    item
  ): item is RetentionPolicyEntry & { resource: LegacyDayforgeRetentionResource; lifetimeDays: number } =>
