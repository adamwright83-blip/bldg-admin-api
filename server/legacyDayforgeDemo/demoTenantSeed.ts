...
export const DEMO_MISSION_IDEMPOTENCY_KEY = "legacy-dayforge-demo-mission-042";
export const DEMO_TENANT_BUSINESS_NAME = "Sunset Laundry Demo";
export const DEMO_OWNER_OPEN_ID = "legacy-dayforge-demo-owner";
export const DEMO_FIELD_OPEN_ID = "legacy-dayforge-demo-field";
...
async function ensureDemoMission(tenantId: string): Promise<CommercialMission> {
  ...
  const created = await createCommercialMission({
    ...
    actor: { type: "system", id: "legacy-dayforge-demo-seed" },
    idempotencyKey: DEMO_MISSION_IDEMPOTENCY_KEY,
    account: {
