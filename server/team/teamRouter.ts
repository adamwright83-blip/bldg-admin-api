...
import { z } from "zod";
import { legacyLegacyDayforgeTenantAdminProcedure, legacyLegacyDayforgeTenantOperatorProcedure, router } from "../_core/trpc";
import { getTeamProjection, saveEmployeeOperatingProfile } from "./teamService";

export const teamRouter = router({
  get: legacyLegacyDayforgeTenantOperatorProcedure.query(({ ctx }) => getTeamProjection({ tenantId: ctx.tenantId })),
  saveProfile: legacyLegacyDayforgeTenantAdminProcedure.input(z.object({
