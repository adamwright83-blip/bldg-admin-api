...
export const moneyRouter = router({
  get: legacyLegacyDayforgeTenantOperatorProcedure.query(({ ctx }) => getMoneyProjection({ tenantId: ctx.tenantId })),
  scenario: legacyLegacyDayforgeTenantOperatorProcedure.input(z.object({
